...
public record Double3(double _d1, double _d2, double _d3) {
   ...
   /**
    * Checks whether any component is greater than a given value.
    * @param  k the value to compare against
    * @return   {@code true} if at least one component is greater than {@code k}
    */
   public boolean isGreaterThan(double k) { return _d1 > k || _d2 > k || _d3 > k; }

   /**
    * Checks whether any component of this triad is greater than the corresponding
    * component of another triad.
    * @param  other the triad to compare with
    * @return       {@code true} if at least one component of this triad is greater
    *               than the corresponding component in {@code other}
    */
